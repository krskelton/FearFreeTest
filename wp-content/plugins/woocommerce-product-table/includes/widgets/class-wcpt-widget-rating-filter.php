...
if ( class_exists( 'WC_Product_Table_Widget' ) ) {
	...
	class WC_Product_Table_Widget_Rating_Filter extends WC_Product_Table_Widget {
		...
		public function __construct() {
			...
			add_filter( 'woocommerce_rating_filter_link', [ 'WC_Product_Table_Widget', 'unescape_commas' ] );
		...
		public function widget( $args, $instance ) {
			...
			$rating_filter = $rating_filter ? array_filter( array_map( 'absint', explode( ',', $rating_filter ) ) ) : [];
